...
<p>The limit on the number of power points a subject can spend on a power remains in effect; thus, a subject may not be able to manifest its highest-level powers. If manifesting a power would cause the manifester to exceed his available power points or his spending limits, the manifestation fails automatically, but no power points are expended.</p>';
    ...
    <dt>Heightened (+4)</dt> <dd>Increase the range and area by 10 feet</dd>
        ...
        $power->description = '<p>Your skin and equipment take on the color and texture of nearby objects, including floors and walls. You receive a +7 enhancement bonus to Hide (Stealth) checks.</p>';
        $power->heightened  = '<dl>
...
<ul>
    <li>Gain Damage Reduction 10 to Cold. You gain 1 Hit Point for every 5 points of Cold damage you absorb. This can cause ice to melt.</li>
    <li>You gain Damage resistance to Cold (half damage)</li>
</ul>';
        $power->heightened = '<dl>
...
<ul>
    ...
    <li>You may pick 2 Fighter Feats that you may use while this power is in effect.</li>
</ul>';
        $power->heightened = '<dl>
    <dt>Heightened (+2)</dt> <dd>You may pick an additional Fight Feat</dd>
    ...
    <dt>Heightened (Expend your Psionic Focus)</dt> <dd>Reduce the number of Actions to Activate this power by 1 Action and the Power Point cost by 1</dd>
        ...
        $power->targets      = 'Self';
        $power->duration     = '10 minutes';
        $power->description  = '<p>You weave a quasi-real ectoplasmic membrane around yourself. You ramain visible within the translucent, amorphous enclosure. This distortion grants you concealment (granting a 20% miss chance). You can pick up or drop objects, easily reaching through the film. Anything you hold is enveloped by the ectoplasm. Likewise, you can engage in melee, make ranged attacks, and manifest powers without hinderance.</p>';
        $power->heightened   = '<dl>
...
<p>You may alter the direction of the wind by as much as 90 degrees.</p>';
    ...
    <dt>Heightened (+1)</dt> <dd>Modify the wind speed by an additional 10 miles per hour. This power can be heightened at most 5 times.</dd>
        ...
        $power->duration       = 'Concentration as a Double Action, up to 10 minutes';

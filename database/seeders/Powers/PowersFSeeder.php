...
class PowersFSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $power->heightened  = '<dl>
    <dt>Heightened (Expend Psionic Focus)</dt> <dd>You may expend your Psionic Focus to lower the Power Point cost by 2 and to use this power as an Immediate Action.</dd>
</dl>';

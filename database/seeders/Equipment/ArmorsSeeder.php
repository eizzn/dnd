...
<p>This armor is load and likely to alert others to your presence. The armor's check penalty applies to Stealth checks even if you meet the required STR score.</p>";
        ...
        $armor->armor_bonus      = 1;
        $armor->damage_reduction = 4;
        $armor->dex_modifier_cap = 2;
        $armor->check_penalty    = -2;
        $armor->speed_penalty    = '-5 feet';
        ...
        $armor->group            = 'Chain';
        $armor->armor_bonus      = 2;
        $armor->damage_reduction = 6;
        $armor->dex_modifier_cap = 1;
        $armor->check_penalty    = -3;
        $armor->speed_penalty    = '-5 feet';
...
<p>This armor's DEX modifier cap also applies to DEX Saves and on all DEX-based skill and ability checks that don't have the attack trait.</p>";
        ...
        $armor->price         = 1;
        $armor->armor_bonus   = 1;
        $armor->check_penalty = 0;
        $armor->spell_failure = 1;
        $armor->bulk          = 'L';
        $armor->weight        = 1;

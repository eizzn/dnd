...
<p>The armor is comfortable, and can be worn while resting</p>";
        ...
        $helper->addPropertiesToSimpleObject($armor, [
            'Armor Class'         => ['value' => 1],
            'Damage Reduction'    => ['value' => '2, Piercing: 1'],
...
<p>This armor is load and likely to alert others to your presence. The armor's check penalty applies to Stealth checks even if you meet the required STR score.</p>";
        ...
        $helper->addPropertiesToSimpleObject($armor, [
            'Armor Class'         => ['value' => 1],
            'Damage Reduction'    => ['value' => '4, Bludgeoning: 3'],
            'DEX Mod Cap'         => ['value' => 2],
...
<p>This armor's DEX modifier cap also applies to DEX Saves and on all DEX-based skill and ability checks that don't have the attack trait.</p>";
        ...
        $helper->addPropertiesToSimpleObject($armor, [
            'Armor Class'         => ['value' => 2],
            'Damage Reduction'    => ['value' => 'Bludgeoning: 4, Piercing: 5, Slashing: 7'],
            'DEX Mod Cap'         => ['value' => 2],
...
<p>This armor's DEX modifier cap also applies to DEX Saves and on all DEX-based skill and ability checks that don't have the attack trait.</p>";
        ...
        $helper->addPropertiesToSimpleObject($armor, [
            'Armor Class'         => ['value' => 3],
            'Damage Reduction'    => ['value' => 'Bludgeoning: 6, Piercing: 7, Slashing: 8'],
            'DEX Mod Cap'         => ['value' => 1],
            'Skill Check Penalty' => ['value' => 3],
        ...
        $helper->addPropertiesToSimpleObject($armor, [
            'Armor Class'         => ['value' => 3],
            'Damage Reduction'    => ['value' => 'Bludgeoning: 5, Piercing: 6, Slashing: 7'],
            'DEX Mod Cap'         => ['value' => 2],
            'Skill Check Penalty' => ['value' => 4],
            'Spell Failure'       => ['value' => '40%'],
            'Speed Penalty'       => ['value' => '10 ft'],
...
<p>This armor's DEX modifier cap also applies to DEX Saves and on all DEX-based skill and ability checks that don't have the attack trait.</p>";
        ...
        $helper->addPropertiesToSimpleObject($armor, [
            'Armor Class'         => ['value' => 3],
            'Damage Reduction'    => ['value' => 'Bludgeoning: 7, Slashing: 9, Piercing: 9'],
            'DEX Mod Cap'         => ['value' => 2],

...
<p>You gain a +5 bonus to the appropriate check to resist Bull Rush, Overrun, and Trip attacks.</p>';
        ...
        $formula->description = '<p>Armor with this rune displaces spell energy, granting the wearer a +1 conditional bonus to Saves against magical effects. When activated, the armor attempts to dispel the triggering spell with the effect of a 6th-level Dispel Magic spell and a spell roll of +10.</p>';
...
<p>Triggering the size change in either direction requires an Action.</p>';
        ...
        $helper->saveFormula($formula, ['Enchantment', 'Formula', 'Transmutation', 'Magical', 'Rune'], [
            'skills' => ['Crafting' => ['dc' => 7, 'meta' => 'Rune Etching']],
            'spells' => ['Cooling Breeze', 'Fiery Furnace', 'Endure Elements'],
            'feats'  => ['Craft Armament'],
        ]);
...
<table>
    <tbody>
        ...
        $formula->activation  = 'Action Command Activation';
        $formula->description = '<p>This weapon is empowered by flickering flames. The weapon deals additional Fire damage on a hit and additional effects on a Critical Hit.</p>
<table>
    <tbody>
        <tr>
            <th>Type</th>

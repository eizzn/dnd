...
class FeatsDivineSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $helper->addTypesToFeat($feat, ['Divine', 'Channel Divinity']);
        $feat->features()->save(app()->features['channel_divinity']);

        $feat              = new Feat;
        $feat->name        = 'Quick Channel Divinity';
        $feat->description = '<p>You can now manifest your Channel Divinity abilities with an Action.</p>';
        $helper->addTypesToFeat($feat, ['Divine', 'Channel Divinity']);
        $feat->features()->save(app()->features['channel_divinity']);
...
<ul>
    ...
    <li>You may not take the Knight of Stars or the Servant of the Heavens feat. Your allegiance is only yours to give once.</li>
        ...
        $helper->addTypesToFeat($feat, ['Exalted', 'Good', 'Neutral']);
...
<ul>
    ...
    <li>You may not take the Favored of the Companions or the Servant of the Heavens feat. Your allegiance is only yours to give once.</li>
        ...
        $helper->addTypesToFeat($feat, ['Exalted', 'Good', 'Chaotic']);
...
<ul>
    ...
    <li>
        ...
        <ul>
            <li>Your Animal Companion gains the Celestial Creature template.</li>
            <li>You may gain a Blink Dog as your Animal Companion by Sacrificing 2 Spell Points and a 3rd level Spell Slot</li>
        </ul>
    </li>
...
<p>You gain a +2 Bonus to all your Saves.</p>';
        $helper->addTypesToFeat($feat, ['Exalted', 'Good']);
...
<ul>
    ...
    <li>If you fail a Save against poison or drugs, you are allowed a second attempt to Save on your next turn (if the poison or drug allows any form of second Save, then ignore the second Save from this feat).</li>
...
<p><strong>Special</strong> To fulfill your vow, you must abstain from any sexual contact with any other creature. If you intentionally break your vow, you immediately and irrevocably lose the benefit of this feat. You may not take another feat to replace it. If you break your vow as a result of magical compulsion, you lose the benefit of this feat until you perform a suitable penance and receive an Atonement spell.</p>';
    ...
    <li>If you intentionally break your vow, you immediately and irrevocably lose the benefit of this feat. You may not take another feat to replace it. If you break your vow as a result of magical compulsion, you lose the benefit of this feat until you perform a suitable penance and receive an Atonement spell.</li>
</ul>
...
<ul>
    ...
    <li>You gain an additional 2nd Level Spell Slot. If you do not have any Levels in a Spell Casting class, then pick any 2nd Level Spell. You may now cast this spell 1/day.</li>
</ul>
...
<ul>
    ...
    <li>You may not take the Thrall to Demon or Slave of the Yugoloths feat. Your allegiance is only yours to give once.</li>
        ...
        $helper->addTypesToFeat($feat, ['Vile', 'Evil', 'Lawful']);
...
<ul>
    ...
    <li>You may not take the Thrall to Demon or Disciple of Darkness feat. Your allegiance is only yours to give once.</li>
        ...
        $helper->addTypesToFeat($feat, ['Vile', 'Evil', 'Neutral']);
...
<ul>
    ...
    <li>You may not take the Disciple of Darkness or Slave of the Yugoloths feat. Your allegiance is only yours to give once.</li>
        ...
        $helper->addTypesToFeat($feat, ['Vile', 'Evil', 'Chaotic']);
...
<ul>
    ...
    <li>3/day, you may cast the spell Fear as a Triple Action.</li>
        ...
        $helper->addTypesToFeat($feat, ['Vile', 'Evil']);
...
<ul>
    ...
    <li>You can see Invisible objects at will as if you have the See Invisibility spell active. It requires an Action to use and Concentration to maintain.</li>
    <li>You gain a +1 Bonus vs spells with the Glamor type.</li>
    <li>You gain a +1 Bonus to all Ranged attacks</li>
...
<ul>
    ...
    <li>Chose a 1st level spell from the Wizard Spell List. You may cast this spell Once per day. You cannot heighten the spell.</li>
...
<p>You may not take the Deformity (Gaunt) feat.</p>';
    ...
    <li>Evil creatures automatically recognize the symbol now emblazoned upon you as a sign of your utter depravity or discipleship to a powerful patron, although the specific identity of the patron is not revealed. You gain a +2 circumstance Bonus on Diplomacy and Intimidate checks made against evil creatures.</li>
        ...
        $feat->description = '<p>You gain the following.</p>
<ul>
    <li>You gain a +4 Bonus to all Sacrifice checks</li>
    <li>You gain a +2 Bonus to all Religion checks</li>
    <li>You may memorize an additional Cantrip</li>
    <li>You gain Sudden Strike Feat. If you already have the Sudden Strike Feat, then you may take any other Precision Feat you qualify for.</li>
</ul>';
        $helper->addTypesToFeat($feat, ['Vile', 'Evil', 'Precision']);

        $feat              = new Feat;
        $feat->name        = 'Demonologist';
        $feat->description = '<p>You study Demons and the Abyss where they reside.</p>
<ul>
    <li>You may now cast the Charm spell three times per day, and have it affect Demons. Targeting a Demon with a Charm spell does not count as an attack for a Demon in a Circle of Protection. Demons have Disadvantage on Saves vs your Charm spells. Unless you have the Charm spell from another class, you may only target Demons with your Charm spell.</li>
    ...
    <li>You learn the True Name of one minor Demon</li>
        ...
        $helper->addTypesToFeat($feat, ['Arcane', 'Demon']);
...
<ul>
    <li>You may now cast the Hold Person spell (Heightened +2) and have it affect Demons. Targeting a Demon with a Hold Person spell does not count as an attack for a Demon in a Circle of Protection. Demons have Disadvantage on Saves vs your Hold Person spells. Unless you have the Hold Person spell from another class, you may only target Demons with your Hold Person spell.</li>
    <li>You may now cast the Dominate spell (Heightened +1) and have it affect Demons. Targeting a Demon in a with a Dominate spell does not count as an attack for a Demon in a Circle of Protection. Unless you have the Dominate spell from another class, you may only target Demons with your Dominate spell.</li>
    <li>You may call a Vrock to serve you for 1 year. You must offer a sacrifice of 3 living humanoids to the Vrock for its service. You may only have a single Vrock serve you in this way at a time.</li>
    ...
    <li>If you have the Favored Enemy Class Feature, your Animal Companion gains all the benefits of your Favored Enemy.</li>
        ...
        $helper->addTypesToFeat($feat, ['Animal Companion', 'Primal']);

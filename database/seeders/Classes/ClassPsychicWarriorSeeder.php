    ...
    public function run()
    {
        ...
        $helper->addPowersToClass($class, [
            ...
            2 => ['Acid', 'Animal Sight', 'Biofeedback', 'Body Equilibrium', 'Body Purification', 'Cloud Mind', 'Compression',
                'Concealing Ectoplasm', 'Danger Sense', 'Darkness', 'Deafness', 'Dimension Swap', 'Ectoplasmic Weapon',
                'Exhaust', 'Flex Form', 'Invisibility', 'Levitate', 'Physical Augmentation', 'Scent', 'Weapon Arm', ],
            3 => ['Battlesense', 'Blindness', 'Drain Vigor', 'Ectoplasmic Form', 'Flame Breath', 'Immovability', 'Wings',
                'Ubiquitous Sight', ],
            4 => ['Acid Absorption', 'Dimension Door', 'Energy Adaptation', 'Inertial Barrier', "Out of Time's Grip", 'Psychic Drain'],

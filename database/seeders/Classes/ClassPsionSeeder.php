    ...
    public function run()
    {
        ...
        $helper->addPowersToClass($class, [
            ...
            3 => ['Air Walk', 'Blindness', 'Body Purification', 'Dismiss Ectoplasm', 'Dispel Psionics', 'Ectoplasmic Form',
                'Flame Breath', "Gem Dragon's Roar", 'Haste', 'Memory Modification', 'Psionic Blast', 'Time Hop', 'Wings',
                'Wisdom Blast', ],
            4 => ['Acid Absorption', 'Control Body', 'Death Urge', 'Dimension Door', 'Dismissal', 'Divination', 'Dominate',
                'Energy Adaptation', 'Fabricate', 'Fly', 'Inertial Barrier', 'Intellect Fortress', 'Life Blast', 'Metamorphosis',
                "Out of Time's Grip", 'Power Leech', 'Psychic Reformation', 'Quintessence', 'Schism', 'Teleport Trigger',
                'Wall of Ectoplasm', 'Wither', ],

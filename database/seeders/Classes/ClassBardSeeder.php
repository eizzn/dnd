    ...
    <dt>Failure</dt> <dd>The Inspiration lasts 1 round, but you don't spend the Spell Point for casting the Inspiration spell.</dd>
        ...
        $helper->addSpellsToClass($class, [
            0 => ['Accelerated Movement', 'Allegro', 'Arcane Mark', 'Blade Ward', 'Boon', 'Cheat', 'Clean Self', 'Conjure Instrument',
                ...
                'Prestidigitation', 'Resistance', 'Rouse', 'Share Talents', 'True Strike', 'Undersong', 'Vicious Mockery', ],
            ...
            2 => ['Animate Instrument', 'Appraising Eye', "Bear's Endurance", 'Breath of Bewilderment', "Bull's Strength",
                'Calm Emotion', "Cat's Grace", 'Crescendo', 'Dance of Ruin', 'Delay Poison', 'Dispel Silence', 'Dissonant Chant',
                "Eagle's Splendor", 'Enthrall', 'False Lie', 'Fortissimo', "Fox's Cunning", 'Glossolalia', 'Grace', 'Hymn of Willpower',
                'Insidious Ear Worm', 'Invisibility', 'Knock', 'Levitate', 'Magic Mouth', 'Mirror Image', 'Misdirection',
                'Note', "Owl's Wisdom", 'Painful Echoes', 'Phantasmal Force', 'Shatter', 'Silence', 'Sonic Burst', "Spymaster's Coin",
                'Suggestion', 'Swift Ready', 'Torrent of Tears', 'Vertigo', 'Vocalize', 'Zone of Truth', ],
            3 => ['Celebration', 'Crushing Despair', 'Dissonant Chord', 'Drums of War', 'Good Hope', 'Hymn of Praise', 'Hypnotic Pattern',
                ...
                'Sending', 'Sepia Snake Sigil', 'Tongues', 'Wounding Whispers', ],
            4 => ['Battle Song', 'Compulsion', 'Confusion', 'Dancing Sword', 'Deafening Blast', 'Follow the Leader', 'Freedom of Movement',
                ...
                'Pacification', 'Secure Shelter', 'War Cry', ],

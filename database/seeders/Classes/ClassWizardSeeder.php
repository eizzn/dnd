...
<p>Once per day when you finish a Short Rest, you can choose expended spell slots to recover. The spell slots can have a combined level that is equal to or less than half your class level (rounded up), and none of the slots can be 6th level or higher.</p>';
        ...
        $helper->addSpellsToClass($class, [
            ...
            2 => ['Acid Arrow', 'Air Sphere', 'Alter Self', 'Allied Footsteps', 'Animate Air', 'Animate Earth', 'Animate Fire',
                'Animate Objects, Lesser', 'Anticipate Teleportation', 'Apport Object', 'Aquavision', 'Arcane Lock', "Arcanist's Magic Aura",
                'Arms of Plenty', 'Battering Ram', "Bear's Endurance", 'Bestow Curse', 'Blindness', 'Blindsight', 'Bloodwater',
                'Blur', "Bull's Strength", "Cat's Grace", 'Caustic Smoke', 'Celerity', 'Chilling Chamber', 'Cling', 'Choke',
                'Comprehend Languages', 'Continual Flame', 'Control Temperature', 'Create Crawling Claw', 'Darkness', 'Darkvision',
                'Deafness', 'Death Armor', 'Decastave', 'Dimension Hop', 'Discern Bloodline', 'Discolor Astral Pool', "Eagle's Splendor",
            ...
            3 => ['Abolish Shadows', 'Absorb Strength', 'Amanuensis', 'Amethyst Field', 'Amorphous Form', 'Animate Dead',
                ...
                'Clairvoyance', 'Clearstone', 'Cone of Dimness', 'Contingent Spell Lock', 'Corpse Candle', 'Crystalbrittle',
                'Dancing Sword', 'Distort Summons', 'Detect Metal and Mineral', 'Discern Shapechanger', 'Dispel Magic',
                'Ectoplasmic Decay', 'Erupting Earth', 'Ethereal Mount', 'Explosive Runes', 'Fireball', 'Flaming Fist',
                'Flame Arrows', 'Fly', 'Force Shapechange', 'Forced Incorporeality', 'Forced Manifestation', 'Gaseous Form',
                'Ghost Touch', 'Ghost Lantern', 'Glowing Orb', 'Glyph of Warding', 'Half', 'Haste', 'Heal Animal Companion',
            ...
            4 => ['Aboleth Curse', 'Anti-Summoning Shell', 'Aqueous Column', 'Arcane Eye', 'Astral Hospice', 'Backblast',
                ...
                'Faithful Hound', 'Finger of Agony', 'Fire Shield', 'Force Chest', 'Force Orb', 'Freedom of Movement',
                'Ghost Trap', 'Globe of Invulnerability', 'Gloom', 'Heart of Earth', 'Ice Storm', 'Image Swap', 'Kiss of the Vampire',
                'Lightning Fog', 'Phantasmal Killer', 'Polymorph', 'Polymorph Self', 'Portal View', 'Private Sanctum',
                'Psychic Poison', 'Resilient Sphere', 'Scramble Portal', 'Secret Chest', 'Secure Shelter', 'Seed of Undeath',
                'Shape Stone', 'Sickness', 'Spell Immunity', 'Spell Matrix', 'Steelsting', 'Stoneskin', 'Stop', 'Summon Demon',
                'Suspension', 'True Form', 'Veil', 'Venom Bolt', 'Vitriolic Sphere', 'Wall of Fire', 'Water to Poison',
                'Watery Sphere', 'Waves of Fatigue', 'Wingbind', ],
            5 => ['Animate Objects', 'Anticold Sphere', 'Antielectricity Sphere', 'Antifire Sphere', 'Antilife Shell', 'Arcane Hand',
                ...
                'Gem Tracer', 'Ghoul Gauntlet', 'Haunt Shift', 'Heart of Fire', 'Immolation', 'Life Bubble',
            ...
            6 => ['Arcane Gate', 'Awaken Undead', 'Baleful Polymorph', 'Baleful Teleport', 'Brilliant Weapon', 'Chain Lightning',
                ...
                'Guards and Wards', 'Heart of Stone', 'Incorporeal Nova', 'Invoke Magic', 'Magic Jar', 'Magnetism', 'Malevolent Tentacles',
            ...
            7 => ['Ability Rip', 'Antimagic Ray', 'Arcane Sword', 'Befoul', 'Call Kolyarut', 'Contingency', 'Etherealness',
                'Finger of Death', 'Forcecage', 'Freedom', 'Ghost Form', 'Hindsight', 'Illusion Purge', 'Magnificent Mansion',
                'Phase Door', 'Plane Shift', 'Possession', 'Power Word Blind', 'Power Word Pain', 'Prismatic Spray', 'Project Image',
                'Radiant Assault', 'Reverse Gravity', 'Sequester', 'Simulacrum', "Slaver's Stern Reproof", 'Soul Link',
                'Spell Turning', 'Stone Body', 'Stone Trap', 'Symbol', ],

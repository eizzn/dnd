...
<p>Once per day when you finish a Short Rest, you can choose expended spell slots to recover. The spell slots can have a combined level that is equal to or less than half your class level (rounded up), and none of the slots can be 6th level or higher.</p>';
        ...
        $helper->addSpellsToClass($class, [
            ...
            1 => ['Air Bubble', 'Alarm', 'Amplify Sound', 'Animate Water', 'Arcane Pocket', 'Arcane Sensitivity', 'Breath of Bewilderment',
                ...
                'Enlarge Skeleton', 'Erase', 'Expeditious Retreat', 'Faerie Fire', 'Feather Fall', 'Fiery Furnace', 'Float',
                'Floating Disk', 'Fog Cloud', 'Force Object', 'Flying Dagger', 'Frost Fingers', 'Gaze Screen', 'Glue', 'Grease',
                'Guiding Light', 'Hail of Ectoplasm', 'Hide from Undead', 'Hypnotism', 'Illusory Script', 'Immunity to Adhesive',
                'Instant Diversion', 'Ironguts', 'Jump', 'Know Wizard School', 'Launch Item', 'Mage Armor', 'Magic Missile',
                'Masque Mask', "Nature's Favor", 'Negative Energy Ray', 'Nether Trail', 'Obscure Object', 'Oilskin', 'Pleasant Visage',
                'Portal Stabilization', 'Protection From Possession', 'Ray of Clumsiness', 'Resist Planar Alignment', 'Rouse',
                'Scatterspray', 'Shock Bolt', 'Silent Image', 'Snare', 'Snatch', 'Sonic Blast', 'Spectral Ears', 'Sticks and Stones',
                'Sticky', 'Summon Elemental, Lesser', 'Tar', 'Thunderwave', 'Undead Servant', 'Unseen Servant', 'Ventriloquism',
                'Wall of Smoke', 'Water to Acid', 'Weather Sense', ],

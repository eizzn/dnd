...
<p>Once per day when you finish a Short Rest, you can choose expended spell slots to recover. The spell slots can have a combined level that is equal to or less than half your class level (rounded up), and none of the slots can be 6th level or higher.</p>';
        ...
        $helper->addFeaturesToClass($class, [
            'wizard_feat'     => [2, 3, 6, 9, 12, 15, 18, 20],
            'arcane_recovery' => [4],
        ]);
        ...
        $helper->addFeatsToClass($class, [
            'Spell Pool'          => 1,
            'Light Armor Caster'  => 2,
            'Arcane Strike'       => 7,
            'Quick Mind'          => 7,
            'Improved Quick Mind' => 12,
            ...
            'Split Ray'           => 4,
            'Delay Spell'         => 5,
            'Energy Substitution' => 5,
            'Persistent Spell'    => 6,
            'Repeat Spell'        => 6,
            'Improved Hold Spell' => 7,
            'Twin Spell'          => 7,
            'Quicken Spell'       => 8,
            ...
            'Spell Focus'          => 4,
            'Improved Spell Focus' => 9,
            'Greater Spell Focus'  => 15,
        ]);

        $helper->addSpellsToClass($class, [
            0 => ['Acid Splash', 'Arcane Mark', 'Booming Blade', "Bronze Dragon's Wrath", 'Cheat', 'Chill Touch', 'Chromatic Ray',
                'Clean Self', 'Combat Quickness', "Copper Dragon's Trickery", 'Corrosive Grasp', 'Cutting Hand', 'Dancing Lights',
                'Daze', 'Detect Ghost', 'Detect Magic', 'Detect Undead', 'Disrupt Ectoplasm', 'Disrupt Undead', 'Electric Arc',
                'False Arcane Eye', 'Fire Bolt', 'Fist of Ice', 'Flare', 'Frostbite', 'Green-Flame Blade', 'Ghost Sound',
                'Launch Bolt', 'Light', 'Mage Hand', 'Mending', 'Message', 'Minor Illusion', 'Modify Foretelling', 'Neutral Water',
                'Prestidigitation', 'Poison Spray', 'Produce Flame', 'Ray of Flame', 'Ray of Frost', 'Resistance', 'Sand Dagger',
                'Shield', 'Shocking Grasp', 'Silent Opening', "Slaver's Gentle Reminder", 'Slide', 'Soft Landing', 'Sonic Snap',
                'Summon Animal, Lesser', 'Telekinetic Projectile', 'Wind Compass', ],
            1 => ['Air Bubble', 'Alarm', 'Amplify Sound', 'Animate Water', 'Arcane Pocket', 'Arcane Sensitivity', 'Breath of Bewilderment',
                ...
                'Cooling Breeze', 'Detect Aberration', 'Detect Charm', 'Disguise Self', 'Drug Resistance', 'Ectoplasmic Armor',
                'Enchant Item', 'Enlarge Skeleton', 'Erase', 'Expeditious Retreat', 'Faerie Fire', 'Feather Fall', 'Fiery Furnace',
                'Float', 'Floating Disk', 'Fog Cloud', 'Force Object', 'Flying Dagger', 'Frost Fingers', 'Gaze Screen',
                'Glue', 'Grease', 'Guiding Light', 'Hail of Ectoplasm', 'Hide from Undead', 'Hypnotism', 'Illusory Script',
                'Immunity to Adhesive', 'Instant Diversion', 'Ironguts', 'Jump', 'Know Wizard School', 'Launch Item', 'Mage Armor',
                'Magic Missile', 'Masque Mask', "Nature's Favor", 'Negative Energy Ray', 'Nether Trail', 'Obscure Object',
                'Oilskin', 'Pleasant Visage', 'Portal Stabilization', 'Protection From Possession', 'Ray of Clumsiness',
                'Resist Planar Alignment', 'Rouse', 'Scatterspray', 'Shock Bolt', 'Silent Image', 'Snare', 'Snatch', 'Sonic Blast',
                'Spectral Ears', 'Sticks and Stones', 'Sticky', 'Summon Elemental, Lesser', 'Tar', 'Thunderwave', 'True Strike',
                'Undead Servant', 'Unseen Servant', 'Ventriloquism', 'Weather Sense', ],
            2 => ['Acid Arrow', 'Air Sphere', 'Alter Self', 'Allied Footsteps', 'Animate Fire', 'Anticipate Teleportation',
                ...
                'Death Armor', 'Decastave', 'Dimension Hop', 'Discern Bloodline', 'Discolor Astral Pool', 'Dispel Fog',
                "Eagle's Splendor", 'Ectoplasmic Web', 'Endure Elements', 'Enlarge', 'Empower Familiar', 'False Life',
                'Feign Death', 'Fetid Breath', 'Filter', 'Fireburst', 'Flame Dagger', 'Flaming Sphere', 'Flash', 'Floating Page',
                'Floating Step', "Fox's Cunning", 'Gentle Repose', 'Ghoul Touch', 'Gust of Wind', 'Heart of Air', 'Hearty Heave',
                'Humanoid Form', 'Hurl', 'Hypercognition', 'Illusory Form', 'Immovable Object', 'Invisibility', 'Invisibility, Swift',
                'Knock', 'Levitate', 'Locate Node', 'Locate Object', 'Magic Mouth', 'Magic Weapon', 'Mesmerizing Gaze',
                'Mindburn', 'Mirror Image', 'Misdirection', 'Misty Step', 'Necrotic Grasp', 'Obscuring Mist', "Owl's Wisdom",
                'Pest Form', 'Phantasmal Force', 'Pillar of Sand', 'Power Word Sleep', 'Portrait', 'Pressure Resistance',
                'Protection From Arrows', 'Pyrotechnics', 'Ray of Enfeeblement', 'Ray of Stupidity', 'Resist Acid', 'Resist Elements',
                'Resist Cold', 'Resist Electricity', 'Resist Fire', 'Resist Force', 'Resist Poison', 'Resist Sonic', 'Resist Turning',
                'Rigor Mortis', 'Rope Trick', 'Scale Weakening', 'Scorching Ray', 'See Invisibility', 'Shadow Shroud', 'Shatter',
                'Shrink', 'Shroud of Undeath', 'Silence', 'Skyhook', 'Slumberward', 'Sonic Burst', 'Sonic Weapon', 'Speaking Stones',
                'Spectral Hand', 'Spider Climb', 'Spectral Eyes', 'Suggestion', 'Telekinetic Maneuver', 'Undead Bane Weapon',
                'Vocalize', 'Vulnerability', 'Warding Wind', 'Water Walk', 'Web', ],
            3 => ['Abolish Shadows', 'Absorb Strength', 'Amanuensis', 'Amethyst Field', 'Amorphous Form', 'Animate Dead',
                ...
                'Lessen Gravity', 'Lightning Bolt', 'Magic Circle', 'Major Image', 'Mind Poison', 'Mystic Surge', "Night's Mantle",
                'Nondetection', 'Paradox', 'Phantom Steed', 'Pierce Disguise', 'Power Word Deafen', 'Protection From Elements',
                'Protection From Negative Energy', 'Ray of Force', 'Ray of Paralysis', 'Repelling Shield', 'Sending', 'Sepia Snake Sigil',
                'Shockwave', 'Sign of Sealing', 'Siphon', 'Silver Lance', 'Skywrite', "Slaver's Mild Admonishment", 'Sleet Storm',
                'Slow', 'Smoke Breathing', 'Stinking Cloud', 'Storm Shield', 'Summon Demon, Lesser', 'Tidal Wave', 'Tiny Hut',
                'Tiny Servant', 'Thunder Step', 'Tongues', 'Undersea Current', 'Vampiric Touch', 'Vitality Shield', 'Water Breathing',
                'Wall of Sand', 'Wall of Wind', 'Whirling Blade', ],
            4 => ['Aboleth Curse', 'Anti-Summoning Shell', 'Aqueous Column', 'Arcane Eye', 'Astral Hospice', 'Backblast',
                'Blight', 'Call Animal', 'Call Dretch Horde', 'Call Lemure Horde', 'Call Modron Workers', 'Call Yugoloth Mercenaries',
                'Calling', 'Control Water', 'Coral Growth', 'Corporeal Instability', 'Deliquescence', 'Dimension Door',
                'Dimensional Anchor', 'Divination', 'Ebon Ray of Doom', 'Echolocation', 'Elemental Ward', 'Emerald Energy Shield',
                'Energy Spheres', 'Energy Vortex', 'Ethereal Prison', 'Exhaustion', 'Fabricate', 'Faithful Hound', 'Finger of Agony',
                'Fire Shield', 'Force Chest', 'Force Orb', 'Freedom of Movement', 'Globe of Invulnerability', 'Gloom', 'Heart of Earth',
                'Ice Storm', 'Image Swap', 'Kiss of the Vampire', 'Life Drain', 'Lightning Fog', 'Phantasmal Killer', 'Polymorph',
                'Polymorph Self', 'Portal View', 'Private Sanctum', 'Psychic Poison', 'Resilient Sphere', 'Scramble Portal',
            ...
            5 => ['Animate Objects', 'Anticold Sphere', 'Antielectricity Sphere', 'Antifire Sphere', 'Antilife Shell', 'Arcane Hand',
                'Ball Lightning', 'Banishment', 'Bone Blade', 'Burning Blood', 'Calm Air', 'Cloudkill', 'Cone of Cold',
                'Contact Other Plane', 'Create Chosen One', 'Create Darkenbeast', 'Create Slipgate', 'Creation', 'Circlet of Enervation',
                'Dimension Jumper', 'Energy Buffer', 'Fiend Form', 'Firebrand', 'Fiery Protector', 'Flameproof', 'Forbidden Speech',
                'Friend to Foe', 'Geas', 'Gem Tracer', 'Ghost Trap', 'Ghoul Gauntlet', 'Haunt Shift', 'Heart of Fire', 'Immolation',
                'Life Bubble', 'Lightning Leap', 'Locate Gate', 'Mailed Might of the Magelords', 'Misty Step, Greater',
                'Moonbow', 'Negative Energy Flood', "Night's Caress", 'Passwall', 'Planar Adaption', 'Planar Binding', 'Prismatic Ray',
                ...
                'Spell Theft', 'Summon Elemental', 'Telekinesis', 'Telepathic Bond', 'Teleportation Circle', 'Trace Teleport',
            ...
            6 => ['Arcane Gate', 'Awaken Undead', 'Baleful Polymorph', 'Baleful Teleport', 'Brilliant Weapon', 'Chain Lightning',
                ...
                'Eye of Stone', 'Eyebite', 'Familiar Refuge', 'Flesh to Stone', 'Forbiddance', 'Freezing Sphere', 'Gate Seal',
                'Glassee', 'Guards and Wards', 'Incorporeal Nova', 'Invoke Magic', 'Magic Jar', 'Magnetism', 'Malevolent Tentacles',
            ...
            7 => ['Ability Rip', 'Antimagic Ray', 'Arcane Sword', 'Befoul', 'Call Kolyarut', 'Contingency', 'Delayed Blast Fireball',
                'Energy Immunity', 'Etherealness', 'Finger of Death', 'Forcecage', 'Freedom', 'Ghost Form', 'Heart of Stone',
                'Hindsight', 'Illusion Purge', 'Magnificent Mansion', 'Phase Door', 'Plane Shift', 'Possession', 'Power Word Blind',
                'Power Word Pain', 'Prismatic Spray', 'Project Image', 'Radiant Assault', 'Reverse Gravity', 'Sequester',
                'Simulacrum', "Slaver's Stern Reproof", 'Soul Link', 'Spell Turning', 'Stone Body', 'Stone Trap', 'Symbol', ],
            8 => ['Anitmagic Field', 'Binding', 'Blacksphere', 'Blackstaff', 'Clone', 'Control Weather', 'Demand', 'Demiplane',
                'Earthquake', 'Evolve', 'Excavate', 'Eye of Power', 'Feeblemind', 'Incendiary Cloud', 'Iron Body', 'Lightning Ring',
                'Maze', 'Orb of the Void', 'Power Word Stun', 'Prismatic Bow', 'Scintillating Pattern', 'Screen', "Slaver's Wrathful Castigation",
                'Soul Theft', 'Spell Engine', 'Sunburst', 'Timereaver', ],

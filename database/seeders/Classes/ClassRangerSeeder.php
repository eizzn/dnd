    ...
    public function run()
    {
        ...
        $helper->addSpellsToClass($class, [
            1 => ['Accelerated Movement', 'Alarm', 'Animal Friendship', 'Beast Bond', 'Calm Animals', 'Camouflage', 'Combat Quickness',
                ...
                'Silvered Weapon', 'Snare', 'Snow Boots', 'Snow Sight', 'Speak with Animals', ],
            2 => ['Animal Messenger', 'Animal Sense', 'Animate Weapon', 'Bane Bow', 'Barkskin', "Bear's Endurance", "Cat's Grace",
                'Cordon of Arrows', 'Cure Wounds', 'Darkvision', 'Dispel Fog', 'Easy Trail', 'Fell the Greatest Foe', 'Find Traps',
                'Flame Arrows', 'Heal Animal Companion', "Hunter's Eye", "Hunter's Haste", 'Lay of the Land', 'Leap Into Animal',
                "Nature's Rampart", "Owl's Wisdom", 'Pass Without Trace', 'Protection From Poison', 'Quieting Weapons',
                'Restful Cloak', 'Resist Poison', 'Scent', 'Snake Arm', 'Summon Animals', ],
            3 => ['Animal Form', 'Barrage', 'Enlarge', 'Entangle', 'Keen Edge', 'Neutralize Poison', 'Plant Growth',
                'Safe Clearing', ],
        ...
        $helper->addFeaturesToClass($class, [
            'class_group_feat'    => [3, 4, 9, 10, 13, 16, 19, 20],
            'wild_empathy'        => [1],
            'favored_terrain'     => [1],
            'favored_enemy'       => [2],
            'study_enemy'         => [3],

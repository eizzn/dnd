...
<p>You can attempt to possess any humanoid within 100 feet of you that you can see (creatures warded by a protection from evil and good or magic circle spell can’t be possessed). The target must make a CHA Save. On a failure, your soul moves into the target’s body, and the target’s soul becomes trapped in the container. On a success, the target resists your efforts to possess it, and you can’t attempt to possess it again for 24 hours.</p>
...
<p>This spell can physically repair a magic item or construct, but the spell can’t restore magic to such an object.</p>';
        ...
        $spell->description    = "<p>You gain a Gaze attack. As an Action, you can stare in a direction, your gaze is a 30-foot cone shape emanation. You may pick up to 3 targets in the area. If they are able to see you, they must make a WIS Save or be Dazed: 5. <strong>Sustain:</strong> On each of your turns after the turn you cast this spell, you must spend 1 Action to sustain it, keeping the Dazed condition on those that Failed their Save. If you do not, the spell ends. You may use an additional Action to force new targets or previous targets that Succeeded their Save to make a WIS Save or be Dazed for the duration. You may never have more Dazed targets then your maximum allowed limit.</p>
...
<p>A mesmerized creature's ally may shake it free of the spell as an Action.</p>";
    ...
    <dt>Heightened (+1)</dt> <dd>Double the number of possible Targets</dd>
        ...
        $helper->addTypesToSpell($spell, ['Illusion', 'Visual', 'Compulsion', 'Sustained'], 2);
...
<p>All effects are the same, even if the spell to be copied is modified with Meta Magic (you do not need to spend any Spell Points). If the spell requires any decisions to be made or targets to select, you make those decisions when the spell is copied.</p>';
    ...
    <dt>Heightened (+1)</dt> <dd>You can copy a higher level spell.</dd>
        ...
        $helper->addTypesToSpell($spell, ['Enchantment', 'Spend Spell Point'], 5);
...
<p>Each time a creature targets you with an attack during the spell’s duration, roll 2D10 to determine whether the attack instead targets one of your duplicates.</p>
<p>If you have three duplicates, you must roll a 9 or higher to change the attack's target to a duplicate. With two duplicates, you must roll a 10 or higher. With one duplicate, you must roll an 11 or higher.</p>

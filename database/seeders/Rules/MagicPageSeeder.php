...
<p>When the Communal Binding ritual is completed, each bonded creature, including you, contributes a number of D3s equal to their Proficiency bonus to a Communal Pool. These dice are sued when invoking the Communal Bindings' effects and tracked by the creator of the Communal Pool. The pool replenishes fully once all bonded creatures have completed a Long Rest.</p>
...
<ul>
    <li>As an Action, any of the bonded creatures can remove one die from the Communal Pool and add it to their next Attack Roll, Damage Roll or Ability Check. They must choose the die's use when it is taken form the pool, and before rolling the pool die.</li>

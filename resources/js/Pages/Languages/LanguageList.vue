                        ...
                        >
                            <template #filters="{ filters }">
                                <th class="px-4 py-2 border border-gray-300 text-left">
                                    <label for="language-name-filter" class="block text-sm font-medium text-gray-700">Name</label>
                                    <input
                                        id="language-name-filter"
                                        type="text"
                            ...
                            <template #table="{ data }">
                                <tr v-for="language in data" :key="language.id" class="hover:bg-gray-50">

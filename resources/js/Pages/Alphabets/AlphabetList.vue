                        ...
                        >
                            <template #filters="{ filters }">
                                <th class="px-4 py-2 border border-gray-300 text-left">
                                    <label for="alphabet-name-filter" class="block text-sm font-medium text-gray-700">Name</label>
                                    <input
                                        id="alphabet-name-filter"
                                        type="text"
                            ...
                            <template #table="{ data }">
                                <tr v-for="alphabet in data" :key="alphabet.id" class="hover:bg-gray-50">
                                    <td class="px-4 py-2 border border-gray-300">
                                        <NavLink
                                            :href="`/alphabet/${alphabet.id}`"
